...
class SignatureSignSubmitScreen extends StatelessWidget {
  final Signature signature;

  const SignatureSignSubmitScreen({Key? key, required this.signature}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();
    final dateFormat = DateFormat('dd MMM yyyy, hh:mm a');
    final controller = Get.put(SignatureCrudController());
    bool isSigned = signature.signedAt != null && signature.signedLegalName != null;
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    _downloadAttachment(signature.documentUrl, context: context); // call your function here
                  },
                ),
              ],
            ),
            ...
            if (!isSigned)
              Column(
                  ...
                  children: [
                    const SizedBox(height: 12),
                    const Text('Type Full Legal Name *',
                        style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                    ...
                    // Agreement const SizedBox(height: 20),Checkbox
                    Obx(() => CheckboxListTile(
                      value: controller.isAgreementChecked.value,
                      onChanged: (v) => controller.isAgreementChecked.value = v ?? false,
                      title: const Text(
                        'I have read and agree to the terms of this document.\nBy checking this box and typing your name below, you agree that your electronic signature is the legal equivalent of your manual signature on this Agreement.',
                    ...
                    Obx(() => SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: controller.isSigning.value
                            ? null
                            : () => controller.signSignature(signature.id),
